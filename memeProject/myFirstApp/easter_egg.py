...
wn = turtle.Screen()
wn.bgcolor("black")
wn.title("easter_egg/Space Invaders")
wn.bgpic("easter_egg/space_invaders_background.gif")

# Register the shapes
turtle.register_shape("easter_egg/sanders.gif")
turtle.register_shape("easter_egg/trump.gif")
...
player.color("yellow")
player.shape("easter_egg/trump.gif")
player.penup()
...
for enemy in enemies:  # all the enemies are there and now we make this for each enemy
	enemy.color("red")
	enemy.shape("easter_egg/sanders.gif")
	enemy.penup()
